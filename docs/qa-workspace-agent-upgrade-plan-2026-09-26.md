...
M0 进展补记（2026-09-26）：已开始范围、契约与交互冻结，见 [M0 推荐方案与视觉稿](qa-workspace-agent-m0-recommendation-2026-09-26.md)、[资源与协议候选](qa-workspace-agent-m0-contracts-2026-09-26.md)及[固定评测与离线基线](qa-workspace-agent-m0-baseline-2026-09-26.md)。当前为冻结候选 v1，产品评审与量化预算仍待完成；以下保留原计划的里程碑定义，新功能尚未启用。
